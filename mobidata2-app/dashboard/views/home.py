...
from dashboard.charts_and_data import climatizacao_frota_total, climatizacao_frota_por_consorcio, assaltos_por_viagem, metro_pax_transportados_por_ano, metro_pax_transportados_por_mes, aquisicoes_onibus_novos_por_ano, aquisicoes_onibus_novos_por_mes, aquisicoes_onibus_usados_por_mes, historico_idade_media_da_frota, comparativo_frota_operante_frota_total, frota_operante, frota_total
...
def home(request):
    ...
    context = {
        ...
        'grafico_climatizacao_frota_total': grafico_climatizacao_frota_total.to_html(full_html=False, include_plotlyjs='cdn'),
        'grafico_climatizacao_frota_por_consorcio': grafico_climatizacao_frota_por_consorcio.to_html(full_html=False, include_plotlyjs='cdn'),

        'grafico_metro_pax_transportados_por_ano': grafico_metro_pax_transportados_por_ano.to_html(full_html=False, include_plotlyjs='cdn'),
        'grafico_metro_pax_transportados_por_mes': grafico_metro_pax_transportados_por_mes.to_html(full_html=False, include_plotlyjs='cdn'),

        'grafico_assaltos_por_viagem': grafico_assaltos_por_viagem.to_html(full_html=False, include_plotlyjs='cdn'),
    }
