...
ON CONFLICT DO NOTHING;CREATE TABLE IF NOT EXISTS corredores_de_onibus(
...
(2022, 12, 'OUTROS / NI', 'OUTROS / NI', 74);CREATE TABLE IF NOT EXISTS concessionarias(
    id_concessionaria VARCHAR(10) PRIMARY KEY,
    nome_concessionaria VARCHAR(60),
    endereco_garagens VARCHAR(255),
    cep VARCHAR(10),
...
(2023, 170),
(2024, 84)
ON CONFLICT DO NOTHING;-- pg. 53 de 122, anuário 2024
CREATE TABLE IF NOT EXISTS veiculos_novos_adquiridos_por_ano (
    id SERIAL PRIMARY KEY,
    ano INTEGER,
    veiculos INTEGER
